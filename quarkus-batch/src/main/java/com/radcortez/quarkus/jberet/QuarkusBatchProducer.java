...
@Dependent
public class QuarkusBatchProducer {
    @Produces
    public JobContext getJobContext() {
        // TODO - change
        ArtifactCreationContext artifactCreationContext =
            ArtifactCreationContext.getCurrentArtifactCreationContext();
    ...
    private <T> T getProperty(final InjectionPoint injectionPoint) {
        ...
        final Properties properties = reflectiveProperties;
        ...
        return fieldType.isAssignableFrom(String.class) ? (T) rawVal :
               (T) ValueConverter.convertFieldValue(rawVal, fieldType, field, ((JobContextImpl) getJobContext()).getClassLoader());
    }
}
